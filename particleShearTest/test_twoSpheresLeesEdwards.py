...
class TestTwoSpheresLeesEdwards(unittest.TestCase):
    ...
    def setUp(self):
        ...
        theEnsemble.sphereList.append(SphereLinkable("GREY", 20, 200, 120, m=1, my_index=1, theCanvas=theCanvas,
        ...
        theEnsemble.sphereList.append(SphereLinkable("BLUE", 480, 230, 120, m=1, my_index=2, theCanvas=theCanvas,
                                                     doDrawing=True, force_register=theEnsemble,
                                                     size_x=theEnsemble.size_x,
                                                     size_y=theEnsemble.size_y))
    ...
    def test_stress_tensor_LW(self):
        ...
        self.assertTrue(LW[0][0]==0 and LW[1][1]==0 and LW[0][1]==0 and LW[1][0]==0)
